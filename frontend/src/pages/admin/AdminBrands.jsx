import { EyeOff, Pencil, Plus, Search, Tag, Trash2, X } from "lucide-react";
                        ...
                        >
                          ...
                          <td className="px-6 py-4">
                            <div className="flex justify-end gap-2">
                              <button
                                type="button"
                                className="inline-flex items-center gap-1.5 rounded-lg bg-[#57657f] px-3 py-2 text-[0.75rem] font-semibold text-white transition hover:bg-[#4a5870]"
                              >
